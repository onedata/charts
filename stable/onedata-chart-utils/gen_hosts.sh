...
services=('volume-s3' 'volume-nfs' 'volume-ceph' 'volume-gluster' 'volume-swift' 'volume-webdav' \
 'volume-dcache' 'oneprovider' 'onezone' 'saml-idp' 'keycloak' 'luma' 'token-dispenser' 'openfaas' \
 'handle-proxy-mock')
